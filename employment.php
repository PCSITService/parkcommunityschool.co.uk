    ...
    <main class="employment-container">
        ...
        <section class="vacancies-column">
            ...
            <article class="vacancy-card">
                <h3>Horticulture Assistant</h3>
                <a href="assets/recruitment/2025-06/Job Advert Horticulture - Jun25.pdf" class="vacancy-link" target="_blank" aria-label="Download Horticulture Assistant job details">
