<?php
$pageTitle = 'Park Community School | Governors';
...
<style>
    ...
    .modern-modal-body h4 {
        color: #1e3c72;
        margin-bottom: 0.75rem;
        margin-top: 1rem;
    }

    .modern-modal-body h4:first-child {
        margin-top: 0;
    }
...
<section id="meet-the-team" class="modern-section alt-bg">
    <div class="grid-container">
        ...
        <div class="modern-governor-grid">
            <div class="modern-governor-card" data-governor="bharwood">
            ...
            <div class="modern-governor-card" data-governor="arowsell">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="canders">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="rcousins">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="amays">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="mturnernorgate">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="cmiller">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="kdenyer">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="pfry">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" data-governor="ecapaldi">
                <div class="modern-governor-image">
                    <img src="/images/governors/E Capaldi 400 x 400.jpg" alt="Mrs E Capaldi">
                </div>
                <div class="modern-governor-info">
                    <h3 class="modern-governor-name">Mrs E Capaldi</h3>
                    <p class="modern-governor-role">Head of School</p>
                    <span class="modern-view-details">View Details <i class="fas fa-arrow-right"></i></span>
                </div>
            </div>

            <div class="modern-governor-card" data-governor="wgoldsmith">
                <div class="modern-governor-image">
            ...
            <div class="modern-governor-card" style="cursor: default;">
                <div class="modern-governor-image">
    ...
    <div class="grid-container">
        ...
        <div class="committees-modern-grid">
            <div class="committee-modern-card">
                ...
                <p class="committee-modern-desc">The Administration Committee is responsible for the following:</p>
            ...
            <div class="committee-modern-card">
                ...
                <p class="committee-modern-desc">The Performance Committee is responsible for the following:</p>
                <ul class="committee-modern-list">
                    <li>Standards</li>
                    <li>Curriculum</li>
                    <li>Attainment</li>
...
<section class="modern-cta-section" id="becoming-a-governor">
    <div class="grid-container">
        <div class="modern-cta-content">
            ...
            <a href="#" class="modern-btn" id="vacancies-btn">View Vacancies</a>
...
<!-- Governor Modals -->
<div id="bharwood-modal" class="modern-modal">
...
<div id="arowsell-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="canders-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="rcousins-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="amays-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="mturnernorgate-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="cemery-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="cmiller-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="kdenyer-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="pfry-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="ecapaldi-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="wgoldsmith-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
<div id="vacancies-modal" class="modern-modal">
    <div class="modern-modal-content">
        <button class="modern-modal-close">&times;</button>
        <div class="modern-modal-header">
...
document.addEventListener('DOMContentLoaded', function() {
    const governorCards = document.querySelectorAll('.modern-governor-card[data-governor]');
    const modals = document.querySelectorAll('.modern-modal');
    const closeButtons = document.querySelectorAll('.modern-modal-close');
    const vacanciesBtn = document.getElementById('vacancies-btn');
    
    // Open modal on card click
    governorCards.forEach(card => {
        card.addEventListener('click', function() {
            const governorId = this.dataset.governor;
            const modal = document.getElementById(governorId + '-modal');
            if (modal) {
    ...
    if (vacanciesBtn) {
        vacanciesBtn.addEventListener('click', function(e) {
            e.preventDefault();
            const modal = document.getElementById('vacancies-modal');
            modal.classList.add('active');
            document.body.style.overflow = 'hidden';
        });
    }
