...
<main class="employment-container">
    ...
    <section class="vacancies-column">
        ...
        <article class="vacancy-card">
            <h3>Teacher of Maths</h3>
            <div class="button-container">
                <a href="../assets/recruitment/2026-01/Teacher of Maths - January 2026.pdf" class="vacancy-link" target="_blank" aria-label="Teacher of Maths">
