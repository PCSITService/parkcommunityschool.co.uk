...
<body>
  ...
  <section class="section section-1" style="padding: 80px 0; background: linear-gradient(135deg, rgba(163,205,66,0.2) 0%, rgba(255,255,255,1) 100%);">
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
      ...
      <a href="/pages/employment.php" class="button">View Current Vacancies</a>
  ...
  <section class="section section-5 fade-in">
    <div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
      ...
      <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; margin-top: 30px;">
        <a href="/pages/employment.php" class="button">View Vacancies</a>
        <a href="/pages/contact.php" class="button outline">Contact HR Team</a>
      </div>
    </div>
  </section>
