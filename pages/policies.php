        ...
        <div class="grid-x grid-padding-x">
            <div class="cell">
                ...
                <div class="policies-list">
                    <ul id="policiesList">
                        <li data-policy="accessibility"><a href="/pages/accessibility-track.php?from=Policy" target="_blank" class="policy-link">Accessibility</a></li>
                        ...
                        <li data-policy="physical restraint use of reasonable force"><a href="/assets/policies/Physical Restraint  Use of Reasonable Force - April 2026.pdf" target="_blank" class="policy-link">Physical Restraint &amp; Use of Reasonable Force</a></li>
