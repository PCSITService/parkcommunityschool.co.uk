    ...
    <div class="grid-container">
        <div class="grid-x grid-padding-x">
            <div class="cell medium-8 large-8">
                ...
                <p>Theatre, Cinema, Dance and Drama Studios</p>
            </div>
        </div>
    </div>
</header>
            ...
            <div class="cell">
                <div class="space-card">
                    ...
                    <div class="space-uses">
                        <strong>Perfect for:</strong> Dance shows, musical theatre, theatre productions, concert venue, rehearsal room, <a href="/community-services.php">party room, wedding receptions and children's parties</a>.
                    </div>
        ...
        <div class="grid-x grid-padding-x">
            <div class="cell">
                <div class="space-card">
                    ...
                    <div class="space-uses">
                        <strong>Perfect for:</strong> Dance studio, rehearsal room and <a href="/community-services.php">soft play parties</a>.
                    </div>
                </div>
            </div>
        </div>
