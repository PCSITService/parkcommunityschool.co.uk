    ...
    <div class="grid-container">
        <div class="grid-x grid-padding-x">
            <div class="cell medium-8 large-8">
                <h1>Park Community Ventures</h1>
                <p>Working together to benefit the community</p>
            </div>
        </div>
    </div>
</header>
        ...
        <div class="grid-x grid-padding-x">
            <div class="cell medium-6">
                ...
                <div class="charity-info">
                    ...
                    <p>For more information, please ask at <a href="/contact.php">the school reception</a>.</p>
                </div>
            </div>
