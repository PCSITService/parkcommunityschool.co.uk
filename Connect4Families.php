	...
	<div class="row">
		<div class="columns">
           ...
           <div style="text-align: left;">
    			<p><a href="/assets/connect4families/2023-07/activities-connect4families-summer-holidays-2023.pdf" target="_blank">Family Fun Days 2023</a>
        		<img src="/assets/connect4families/2023-07/connect4families-logo.png" alt="Logo" style="float: right; width: 250px; margin-left: 10px;">
   				</p>
	...
	<div class="row">
		<div class="columns">
			...
			<p>Connect4Families and Connect4Youth Activity Book is produced with lots of helpful information to give out to children and parents:
    			...
    			<p><a href="/assets/connect4families/2023-07/activity-book.pdf" target="_blank">Youth Activity Book</a>
	...
	<div class="row">
		<div class="column">
			...
			<p>For further details please contact:</p>
				<li>Email: <a href="mailto:admin@connect4.org.uk">Connect4Families</a></li>
