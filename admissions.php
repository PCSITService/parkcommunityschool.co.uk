...
<html class="no-js" lang="en" >
    <head>
        ...
        <style>
            ...
            .grey-bg h2, .grey-bg h3, .grey-bg h4, .grey-bg a, .grey-bg p {
                color: white;
            }
            ...
            .grey-bg .button.radius {
                background-color: #0078a0;
                color: white;
            }
            
            .grey-bg .button.radius:hover {
...
<section>
    <div class="row">
        <br><!-- Added space at the top since hero was removed -->
        <div class="medium-8 columns">
            ...
            <div class="admissions-card">
                ...
                <div class="text-center" style="margin-top: 2rem;">
                    ...
                    <a href="/forms.php" class="button radius secondary">Use the Form</a>
                </div>
            </div>
        ...
        <div class="medium-4 columns">
            ...
            <div class="admissions-card">
                ...
                <p>If you have any questions or would like help with any aspect of the admissions process, please visit our <a href="/contact.php">Contact Page</a> for details on how to reach our admissions team.</p>
                <div class="text-center">
