...
<html class="no-js" lang="en" >
    <head>
        ...
        <title>Park Community School | SMSC</title>
...
<section>
    <div class="row">
        ...
        <br>
            <h3>Purpose</h3>
            <p>This is the over-arching umbrella that encompasses personal development across our curriculum.</p>
           ...
           <p>To prepare students positively for life in modern Britain, through the promotion of British values, diversity, equality and tolerance of those with different faiths, beliefs and life choices. We also aim to enable students to develop their self knowledge, self esteem and self confidence while giving them the ability to make good life choices and also encouraging them to accept responsibility for their behaviour, it’s consequences, and how they can contribute to the wider world. The programme also covers the 65 elements of the statutory RSE curriculum to ensure pupils are fully prepared to positively manage their relationship choices both within and beyond their time in school.</p>
            ...
            <ul>
                <li>Park Design and Print [PDP] - an introduction to setting up a small business. Students learn how a small business operates, spend some time with each department, sales, design, production and admin.</li>
                <li>PDP Design Project - students work with our professional graphic designer to create a bespoke t-shirt, from start to finish, and then turn the design into reality.</li>
                <li>Park Farm Plant and Grow project – an introduction to horticulture, learning about planting cycles and suitable crops.</li>
                <li>Park Farm Animal Husbandry – an introduction to looking after farm animals in the correct way, including feeding, general care and health.</li>
                <li>Park Kitchen - students are given the opportunity to experience working in our commercial kitchen. The experience covers health and safety and who does what to make a commercial kitchen run smoothly and efficiently to produce great food for large numbers.</li>
                <li>Apex centre – an introduction to some of the different areas of construction which will include skills such as brick laying, plastering, painting and decorating and joinery.</li>
            </ul>
            ...
            <ul>
                ...
                <li><a target="_blank" href="//www.careforthefamily.org.uk/family-life/parent-support">https://www.careforthefamily.org.uk/family-life/parent-support</a></li>
                <li><a target="_blank" href="//www.parentsupportlink.org.uk">https://www.parentsupportlink.org.uk/</a></li>
            </ul>
            <br>
        </div>
