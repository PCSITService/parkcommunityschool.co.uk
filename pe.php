...
<section>
    <div class="row">
        ...
        <!-- ITEM -->
          <li class="accordion-navigation">
            <a href="#panel2d"  role="tab" id="panel2d-heading" aria-controls="panel2d">Assessment and Feedback</a>
        ...
        <!-- ITEM -->
          <li class="accordion-navigation">
            <a href="#panel3d" role="tab" id="panel3d-heading" aria-controls="panel3d">Participation</a>
        ...
        <!-- ITEM -->
          <li class="accordion-navigation">
            <a href="#panel4d" role="tab" id="panel4d-heading" aria-controls="panel4d">Destinations</a>
        ...
        <!-- ITEM -->
          <li class="accordion-navigation">
            <a href="#panel5d" role="tab" id="panel5d-heading" aria-controls="panel5d">Student Voice</a>
        ...
        <!-- ITEM -->
          <li class="accordion-navigation">
            <a href="#panel6d" role="tab" id="panel6d-heading" aria-controls="panel6d">Dictionary of Terms</a>
