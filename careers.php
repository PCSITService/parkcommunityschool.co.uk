...
<html class="no-js" lang="en" >
  <head>
    <title>Park Community School | Careers</title>
  ...
  <body class="page-learning">
    ...
    <section>
      <div class="row">
        ...
        <div class="medium-8 columns">
          ...
          <p><a href="#" data-reveal-id="careers-prepare">Read More...</a></p>
          <!-- MODAL -->
          <div id="careers-prepare" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            <h2 id="modalTitle">How do we prepare you for your next step?</h2>
            ...
            <p>The careers programme is lead by Mrs Munoz the school’s Career Leader, it is reviewed and adapted annually. <a href="/assets/policies/ceiag.pdf">The full Careers Education, Information, Advice and Guidance (CEIAG) Policy</a> can be viewed online. The next few pages will show you exactly what the students experience in each year group within our careers programme.</p>
          ...
          <div id="careers-gatsby" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            ...
            <ol>
              ...
              <li><strong>LEARNING FROM CAREER AND LABOUR MARKET INFORMATION</strong></li>
              ...
              <li><strong>ADDRESSING THE NEEDS OF EACH STUDENT</strong></li>
              ...
              <li><strong>LINKING CURRICULUM LEARNING TO CAREERS</strong></li>
              ...
              <li><strong>ENCOUNTERS WITH EMPLOYERS AND EMPLOYEES</strong></li>
              ...
              <li><strong>EXPERIENCE OF WORKPLACES</strong></li>
              ...
              <li><strong>ENCOUNTERS WITH FURTHER AND HIGHER EDUCATION</strong></li>
              ...
              <li><strong>PERSONAL GUIDANCE</strong></li>
            ...
            <p>Ref: <a href="//www.careersandenterprise.co.uk/schools-colleges/gatsby-benchmarks">Careers and Enterprise Gaysby Benchmarks</a></p>
            <a class="close-reveal-modal" aria-label="Close">&#215;</a>
          </div>
          <!-- /MODAL -->
    ...
    <section class="grey-bg">
      ...
      <div class="row">
        <div class="columns">
          ...
          <ul class="text-center large-block-grid-3 medium-block-grid-3 small-block-grid-1">
            <li>
              <div class="">
                <a href="//bespoke.careercompanion.co.uk/libraries/index" target="_blank">
                  <img style="height: 70px;" src="images/careers/career_companion.jpg" alt="">
            ...
            <li>
              <div class="">
                <a href="//www.fasttomato.com/" target="_blank">
                  <img style="height: 70px;" src="images/careers/fasttomato.jpg" alt="">
                  <p>FastTomato</p>
                </a>
              </div>
            </li>
            <li>
              <div class="">
                <a href="//www.eclips-online.co.uk/" target="_blank">
                  <img style="height: 70px;" src="images/careers/eclips.jpg" alt="">
                  <p>eClips</p>
                </a>
              </div>
            </li>
      ...
      <div class="row">
        ...
        <div class="small-6 small-pull-3 medium-pull-0 medium-4 columns">
          <a href="//ebpsouth.work-experience.co.uk/" target="_blank">
            <img src="images/careers/ebp.jpg" alt="">
          </a>
        </div>
      </div>
      <br>
            ...
            <li>
              <div class="menu-box">
                <a href="//www.hsdc.ac.uk/" target="_blank">
                  <img src="images/careers/hsdc_college_logo.jpg" alt="">
            ...
            <li>
              <div class="menu-box">
                <a href="//www.portsmouth-college.ac.uk/" target="_blank">
                  <img src="images/careers/portsmouth_college_logo.jpg" alt="">
            ...
            <li>
              <div class="menu-box">
                <a href="//www.highbury.ac.uk/" target="_blank">
                  <img src="images/careers/highbury_college_logo.jpg" alt=" ">
            ...
            <li>
              <div class="menu-box">
                <a href="//chichester.ac.uk/" target="_blank">
                  <img src="images/careers/chichester_college_logo.jpg" alt="">
            ...
            <li>
              <div class="menu-box">
                <a href="//www.fareham.ac.uk/" target="_blank">
                  <img src="images/careers/fareham_college_logo.jpg" alt=" ">
                  <p>Fareham College</p>
                </a>
              </div>
            </li>
            <li>
              <div class="menu-box">
                <a href="//www.sparsholt.ac.uk/" target="_blank">
                  <img src="images/careers/sparsholt_college_logo.jpg" alt="">
                  <p>Sparsholt</p>
                </a>
              </div>
            </li>
            <li>
              <div class="menu-box">
                <a href="//www.peta.co.uk/" target="_blank">
                  <img src="images/careers/peta_college_logo.jpg" alt="">
                  <p>PETA</p>
                </a>
              </div>
            </li>
            ...
            <li>
              <div class="menu-box">
                <a href="//www.port.ac.uk/" target="_blank">
                  <img src="images/careers/portsmouth_uni_logo.jpg" alt="">
            ...
            <li>
              <div class="menu-box">
                <a href="//www.chi.ac.uk/" target="_blank">
                  <img src="images/careers/chichester_uni_logo.jpg" alt="">
            ...
            <li>
              <div class="menu-box">
                <a href="//www.southampton.ac.uk/" target="_blank">
                  <img src="images/careers/southampton_uni_logo.jpg" alt="">
            ...
            <li>
              <div class="menu-box">
                <a href="//www.ox.ac.uk/" target="_blank">
                  <img src="images/careers/oxford_uni_logo.jpg" alt="">
    ...
    <section class="grey-bg">
      ...
      <div class="row">
        ...
        <div class="small-6 small-pull-3 medium-pull-0 medium-4 columns">
          <br>
          <img src="images/careers/uni_students.jpg" alt="">
        </div>
      </div>
      <br>
      <?php include ("includes/backtotop.html") ?>
    ...
    <section>
      ...
      <div class="row">
        <div class="columns"> 
          <h2>Where do our students go?</h2>
          <p>Data collected by the Youth Analysis Service (YAS) shows where our students progressed to over the last five years. Due to Raising the Participation Age (RPA) legislation, as of summer 2014, young people are under a duty to participate in education or training until at least their 18th birthday.</p>


          <ul class="accordion" data-accordion role="tablist">
            <li class="accordion-navigation">
              <a href="#studentsgo_panel1d" role="tab" id="studentsgo_panel1d-heading" aria-controls="studentsgo_panel1d">Establishment Leaver Destinations (2013-2017)</a>
              <div id="studentsgo_panel1d" class="content" role="tabpanel" aria-labelledby="studentsgo_panel1d-heading">
                <p>Table 1 below shows the number of Year 11 leavers who were in each destination category for the last five years for Park Community School.</p>
                  ...
                  <table>
                    ...
                    <tr>
                      <td>Sixth Form College/School</td>
                      <td>5</td>
                      <td>13</td>
                      <td>17</td>
                      <td>18</td>
                    ...
                    <tr>
                      <td>Other Ed inc. Traineeship<br></td>
                      <td>0</td>
                      <td>1</td>
                      <td>0</td>
                      <td>1</td>
                    ...
                    <tr>
                      <td>Emp (FT) inc. Apprenticeship</td>
                      <td>9</td>
                      <td>9</td>
                      <td>13<br></td>
                      <td>13</td>
                    ...
                    <tr>
                      <td><strong>Participating Total</strong></td>
                    ...
                    <tr>
                      <td><strong>Not Participating Total</strong></td>
            ...
            <li class="accordion-navigation">
              <a href="#studentsgo_panel2d"  role="tab" id="studentsgo_panel2d-heading" aria-controls="studentsgo_panel2d">Establishment Programme Type and Level</a>
              <div id="studentsgo_panel2d" class="content" role="tabpanel" aria-labelledby="studentsgo_panel2d-heading">
                <p>Table 2 shows the programme types of Year 11 leavers who went on to full time education from Park Community School.</p>
                  ...
                  <table>
                    ...
                    <tr>
                      <td>Level 3 - A Levels</td>
                      <td>32</td>
                      <td>23%</td>
                    </tr>
                    <tr>
                      <td>Level 3 - Technicial</td>
                      <td>30</td>
                      <td>22%</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>Level 2 - Technicial</td>
                      <td>51</td>
                      <td>37%</td>
                    </tr>
                    <tr>
                      <td>Level 1 - Technicial</td>
                      <td>17</td>
                      <td>12%</td>
                    </tr>
                    <tr>
                      <td>Other Education Course inc. Traineeships</td>
                      <td>7</td>
                      <td>5%</td>
                    </tr>
                    <tr>
                      <td><strong>Education Total</strong></td>
            ...
            <li class="accordion-navigation">
              <a href="#studentsgo_panel3d" role="tab" id="studentsgo_panel3d-heading" aria-controls="studentsgo_panel3d">Post 16 Establishments Attended</a>
              <div id="studentsgo_panel3d" class="content" role="tabpanel" aria-labelledby="studentsgo_panel3d-heading">
                <p>Table 3 shows the establishments attended, as of 1st November 2017, by the Year 11 leavers from Park Community School who continued in full-time education at establishment level.</p>

                  <table>
                    <tr>
                      <th>Establishment Attended</th>
                      <th>Female<br></th>
                      <th>Male</th>
                    </tr>
                    <tr>
                      <td>Havant &amp; South Downs College</td>
                      <td>59</td>
                      <td>42</td>
                    </tr>
                    <tr>
                      <td>Highbury College</td>
                      <td>7</td>
                      <td>10<br></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>Portsmouth College</td>
                      <td>1</td>
                      <td>4</td>
                    </tr>
                    <tr>
                      <td>Fareham College<br></td>
                      <td>0</td>
                      <td>3</td>
                    </tr>
                    <tr>
    ...
    <!-- A levels, Vocational Courses, Apprenticeships and HE -->
    <section class="grey-bg">
      <div class="row">
        <div class="small-centered large-1 column text-center hr-logo grey-bg"></div>
      </div>
      <div class="row">
        ...
        <div class="columns">
          ...
          <ul class="text-center large-block-grid-4 medium-block-grid-2 small-block-grid-2">
            <li>
              <div class="menu-box">
                <a href="#" data-reveal-id="Alevels_Modal">
                  <p>A Levels</p>
                </a>
              </div>
            </li>
            <li>
              <div class="menu-box">
                <a href="#" data-reveal-id="Vocational_Modal">
            ...
            <li>
              <div class="menu-box">
                <a href="#" data-reveal-id="Apprenticeship_Modal">
            ...
            <li>
              <div class="menu-box">
                <a href="#" data-reveal-id="HigherEducation_Modal">
          ...
          <!-- MODALS -->
          <!-- A Levels Modal -->
          <div id="Alevels_Modal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            <h2 id="modalTitle">A Levels</h2>
          ...
          <div id="Vocational_Modal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            <h2 id="modalTitle">Vocational Courses</h2>
          ...
          <div id="Apprenticeship_Modal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            <h2 id="modalTitle">Apprenticeships &amp; Degree Level Apprenticeships</h2>
            <h4>What are they?</h4>
            <ul>
            ...
            <ul>
              ...
              <li>You like the idea of working alongside experience staff who will train you.</li>
          ...
          <div id="HigherEducation_Modal" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
            <h2 id="modalTitle">Higher Education</h2>
            <h4>What is it?</h4>
            <ul>
    ...
    <section class="grey-bg">
      ...
      <div class="row">
        ...
        <div class="columns">
          ...
          <ul>
            <li>Email: <a href="javascript:location='mailto:\u0043\u0061\u0072\u0065\u0065\u0072\u0073\u0040\u0070\u0063\u0073\u002e\u0068\u0061\u006e\u0074\u002e\u0073\u0063\u0068\u002e\u0075\u006b';void 0">Careers</a></li>
            <li>Phone Reception: <a href="/contact.php">Contact Information Page</a></li>
      ...
      <div class="row">
        <div class="columns">
          ...
          <ul class="inline-list">
            ...
            <li>Giant Leap</li>
            <li><a href="//www.havant.gov.uk/" target="_blank">Havant Bourgh Council</a></li>
            <li><a href="//www.hants.gov.uk/" target="_blank">Hampshire County Council</a></li>
            <li>IPA</li>
            <li>Norse</li>
            <li>P09 Publications</li>
            <li><a href="/design-print.php" target="_blank">Park Design &amp; Print</a></li>
            ...
            <li><a href="//www.tuppennybarn.co.uk/" target="_blank">Tuppenybarn</a></li>
          </ul>
          ...
          <ul class="circle">
            <li>Mock interviews - spend some time interviewing very nervous students, then choosing your top applicant to “give the job” too.</li>
          ...
          <ul class="circle">
            ...
            <li>Achieving your Corporate Social Responsibility objectives (CRS)</li>
          ...
          <p>If you would like to find out more about the possibility of becoming a business ambassador <br>please contact us via Email: <a href="javascript:location='mailto:\u0042\u0075\u0073\u0069\u006e\u0065\u0073\u0073\u004c\u0069\u006e\u006b\u0073\u0040\u0070\u0063\u0073\u002e\u0068\u0061\u006e\u0074\u0073\u002e\u0073\u0063\u0068\u002e\u0075\u006b';void 0">Bussiness Links</a>.</p>
        </div>
